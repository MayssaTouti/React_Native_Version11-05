...
const SignInScr = ({ navigation }) => {
    ...
    const onTermsOfUserPressed = (val) => {
 ...
 <Animatable.View>
                ...
                {data.isValidUser ? null :
                    <Animatable.View animation="fadeInLeft" duration={500}>
                        <Text style={styles.errorMsg}> Email must be 25 charcters long </Text>
...
{ data.isValidPassword ? null : 
                    <Animatable.View animation="fadefadeInLeftInLeft" duration={500}>
                        <Text style={styles.errorMsg}> Password  must be 8 charcters long </Text>
